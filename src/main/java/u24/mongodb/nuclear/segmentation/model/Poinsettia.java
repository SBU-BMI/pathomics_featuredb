...
public class Poinsettia {
    ...
    public ArrayList<ArrayList<Float>> getPolygonPoints(ArrayList<Double> points)
    {
        ArrayList<ArrayList<Float>> objPointsList = new ArrayList<ArrayList<Float>>();
        for (int j = 0; j < points.size(); j += 2) {
            ArrayList<Float> objPoints = new ArrayList<Float>();
    ...
    public ArrayList<ArrayList<Float>> getPolygonPoints(Point[] points)
    {
        ArrayList<ArrayList<Float>> objPointsList = new ArrayList<ArrayList<Float>>();
